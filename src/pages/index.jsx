...
const docLinkStyle = Object.assign(Object.assign({}, linkStyle), { listStyleType: "none", display: `inline-block`, marginBottom: 24, marginRight: 12 });
...
const IndexPage = () => {
    return (<main style={pageStyles}>
      ...
      <ul style={doclistStyles}>
        {docLinks.map(doc => (<li key={doc.url} style={docLinkStyle}>
      ...
      <ul style={listStyles}>
        {links.map(link => (<li key={link.url} style={Object.assign(Object.assign({}, listItemStyles), { color: link.color })}>
            <span>
              <a style={linkStyle} href={`${link.url}?utm_source=starter&utm_medium=start-page&utm_campaign=minimal-starter-ts`}>
                {link.text}
              </a>
              {link.badge && (<span style={badgeStyle} aria-label="New Badge">
                  NEW!
                </span>)}
